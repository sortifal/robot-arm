...
"")
    ...
    def retranslateUi(self, ArmControl):
        ...
        self.xVal.setText(_translate("ArmControl", "0.3"))
        self.yVal.setText(_translate("ArmControl", "0.0"))
        self.rollVal.setText(_translate("ArmControl", "0"))
        self.zVal.setText(_translate("ArmControl", "0.2"))
        ...
        self.pitchVal.setText(_translate("ArmControl", "0"))
        self.pitchLabel.setText(_translate("ArmControl", "pitch"))
        self.yawVal.setText(_translate("ArmControl", "0"))
    ...
    def plot_data(self):
        ...
        q1b,q2b,q3b,q4b,q5b,q6b = convertionRadStep(q1,q2,q3,q4,q5,q6)
        print("q1 : ",q1b)
        print("q2 : ",q2b)
        print("q3 : ",q3b)
        print("q4 : ",q4b)
        print("q5 : ",q5b)
        print("q6 : ",q6b)
        print(f"G28 {q1b} {q2b} {q3b} {q4b} {q5b} {q6b}")
        #send_qs_over_serial(q1b, q2b, q3b, q4b, q5b, q6b)
...
def send_qs_over_serial(q1, q2, q3, q4, q5, q6):
        # Concatenate the q values into a single string, separated by spaces
        message = f"G28 {q1} {q2} {q3} {q4} {q5} {q6}\n"
        #ser.write(bytearray(message,'ascii'))
        print(f"Sent over serial: {message}")

#ser.write(bytearray("U1\n",'ascii'))
#send_qs_over_serial(0, -27000, -24500, 0, 1400, 0)
#ser.write(bytearray("R0\n",'ascii'))
...
class Main_window(QtWidgets.QMainWindow):
    ...
    def InitSerial(self):
        ...
        #self.arduinoOut = self.SerialObj.getConn('COM3',115200) 
        pass
    def close(self):
        sys.exit()
