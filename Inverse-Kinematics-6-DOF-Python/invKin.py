...
a1, a2, a3 = 0.020174, 0.260986, 0.019219
d1, d4 = 0.28787, 0.260753
dg = 0.074745
...
def get_wrist_center(gripper_point, R0g, dg = dg):
...
def get_angles(x, y, z, roll, pitch, yaw):
  ...
  T0g_a = Matrix([
    [((sin(q1)*sin(q4) + sin(q2 + q3)*cos(q1)*cos(q4))*cos(q5) + sin(q5)*cos(q1)*cos(q2 + q3))*cos(q6) - (-sin(q1)*cos(q4) + sin(q4)*sin(q2 + q3)*cos(q1))*sin(q6), -((sin(q1)*sin(q4) + sin(q2 + q3)*cos(q1)*cos(q4))*cos(q5) + sin(q5)*cos(q1)*cos(q2 + q3))*sin(q6) + (sin(q1)*cos(q4) - sin(q4)*sin(q2 + q3)*cos(q1))*cos(q6), -(sin(q1)*sin(q4) + sin(q2 + q3)*cos(q1)*cos(q4))*sin(q5) + cos(q1)*cos(q5)*cos(q2 + q3), -dg*sin(q1)*sin(q4)*sin(q5) + a2*sin(q2)*cos(q1) - dg*sin(q5)*sin(q2 + q3)*cos(q1)*cos(q4) + a3*sin(q2 + q3)*cos(q1) + dg*cos(q1)*cos(q5)*cos(q2 + q3) + d4*cos(q1)*cos(q2 + q3) + a1*cos(q1)],
    [ ((sin(q1)*sin(q2 + q3)*cos(q4) - sin(q4)*cos(q1))*cos(q5) + sin(q1)*sin(q5)*cos(q2 + q3))*cos(q6) - (sin(q1)*sin(q4)*sin(q2 + q3) + cos(q1)*cos(q4))*sin(q6), -((sin(q1)*sin(q2 + q3)*cos(q4) - sin(q4)*cos(q1))*cos(q5) + sin(q1)*sin(q5)*cos(q2 + q3))*sin(q6) - (sin(q1)*sin(q4)*sin(q2 + q3) + cos(q1)*cos(q4))*cos(q6), -(sin(q1)*sin(q2 + q3)*cos(q4) - sin(q4)*cos(q1))*sin(q5) + sin(q1)*cos(q5)*cos(q2 + q3),  a2*sin(q1)*sin(q2) - dg*sin(q1)*sin(q5)*sin(q2 + q3)*cos(q4) + a3*sin(q1)*sin(q2 + q3) + dg*sin(q1)*cos(q5)*cos(q2 + q3) + d4*sin(q1)*cos(q2 + q3) + a1*sin(q1) + dg*sin(q4)*sin(q5)*cos(q1)],
    [                                                                -(sin(q5)*sin(q2 + q3) - cos(q4)*cos(q5)*cos(q2 + q3))*cos(q6) - sin(q4)*sin(q6)*cos(q2 + q3),                                                                  (sin(q5)*sin(q2 + q3) - cos(q4)*cos(q5)*cos(q2 + q3))*sin(q6) - sin(q4)*cos(q6)*cos(q2 + q3),                                     -sin(q5)*cos(q4)*cos(q2 + q3) - sin(q2 + q3)*cos(q5),                                                                                 -dg*sin(q5)*cos(q4)*cos(q2 + q3) - dg*sin(q2 + q3)*cos(q5) - d4*sin(q2 + q3) + a2*cos(q2) + a3*cos(q2 + q3) + d1],
    [                                                                                                                                                            0,                                                                                                                                                             0,                                                                                        0,                                                                                                                                                                                                              1]])
  ...
  wrist_center = get_wrist_center(gripper_point, R0g_eval, dg = dg)
...
def main():
  ...
  print("q5 : ",q5)
  print("q6 : ",q6)
  q1,q2,q3,q4,q5,q6 = convertionRadStep(q1,q2,q3,q4,q5,q6)
  print("q1 : ",q1)
  print("q2 : ",q2)
  print("q3 : ",q3)
  print("q4 : ",q4)
  print("q5 : ",q5)
  print("q6 : ",q6)
  print(f"G28 {q1} {q2} {q3} {q4} {q5} {q6}")
  #now plot the arm with updated angles
  forward_kin(q1,q2,q3,q4,q5,q6)

def convertionRadStep(q1, q2, q3, q4, q5, q6):
  q1 = round(q1*87040/pi/2)
  q2 = -round(q2*128000/pi/2)
  q3 = round(q3*128000/pi/2)
  q4 = -round(q4*32000/pi/2)-16000
  q5 = round(q5*14880/pi/2)
  q6 = -round(q6*3200/pi/2)
